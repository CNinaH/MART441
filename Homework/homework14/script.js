...
var player;
var stars;
var carrots; //new collectable
var bombs;
var spikes; //added spikes
var platforms;
var cursors;
var score = 0;
var gameOver = false;
...
function create ()
{
    ...
    platforms.create(600, 400, 'ground'); //more platforms
    platforms.create(50, 250, 'ground'); 
    platforms.create(750, 220, 'ground'); 
    platforms.create(100, 400, 'ground'); 
    platforms.create(0, 140, 'ground');

    spikes = this.physics.add.staticGroup();

    spikes.create(480, 365, 'spike'); // lower right
    spikes.create(90, 105, 'spike');  // upper left
    spikes.create(710, 185, 'spike'); //upper right
    spikes.create(195, 365, 'spike'); //lower left
...
function update ()
{
    ...
    if (cursors.space.isDown && player.body.touching.down) //Spacebar jump
    {
...
function collectCarrot (player, carrot){
    ...
    {
        carrots.children.iterate(function (child, index) {
            child.enableBody(true, 50 + index * 100, 0, true, true);
        });
    }
}
